...
namespace FreakyArchitect
{
    ...
    public class SoundManager : SharedInstance<SoundManager>
    {
        [System.Serializable]
        public class Sound
        {
        ...
        public Sound button;
        public Sound placeCube;
        public Sound placeCubeUp;
        ...
        /// the same time to eliminate the issue in which sound amplitude adds up and becomes too loud.
        /// </summary>
